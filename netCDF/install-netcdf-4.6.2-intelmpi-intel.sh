...
pkg=netcdf-4.6.2-intelmpi-intel
src=netcdf-c-4.6.2
...
# Compilation flags
export CPPFLAGS=-I$HOME/.pkg/hdf5-1.10.4-intelmpi-parallel/include
export LDFLAGS="-L$HOME/.pkg/hdf5-1.10.4-intelmpi-parallel/lib -L$HOME/.pkg/curl-7.60.0/lib"
export CC=mpiicc
export FC=mpiifort
export CXX=mpiicpc
