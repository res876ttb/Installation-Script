...
pkg=openmpi-3.1.3-intel
src=openmpi-3.1.3

# url of source code
url=https://download.open-mpi.org/release/open-mpi/v3.1/openmpi-3.1.3.tar.gz

# name of downloaded file
zip=openmpi-3.1.3.tar.gz
...
cm "./configure CC=icc CXX=icpc FC=ifort --prefix=$td --enable-orterun-prefix-by-default CFLAGS=$cflag CXXFLAGS=$cflag FFLAGS=$cflag FCFLAGS=$cflag" "configure $pkg"
