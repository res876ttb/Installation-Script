...
pkg=netcdf-fortran-4.4.4-intel
...
required=" \
  ...
  $HOME/.script/env-netcdf-4.6.1-intel.sh \
"
...
echo Building $pkg...
cd $src
export CPPFLAGS=-I$HOME/.pkg/netcdf-4.6.1-intel/include 
export LDFLAGS=-L$HOME/.pkg/netcdf-4.6.1-intel/lib
