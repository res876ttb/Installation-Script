...
echo Building $pkg...
cd $pkg/
cm "./configure CC=pgcc CXX=pgc++ FC=pgfortran --prefix=$td CFLAGS=$cflag CXXFLAGS=$cflag FFLAGS=$cflag FCFLAGS=$cflag" "configure $pkg"
