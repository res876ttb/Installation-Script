...
zip=zlib-1.2.11.tar.gz

# target directory
td=$HOME/.pkg/zlib-1.2.11
...
# required package
required="$HOME/.script/env-cmake-3.11.2.sh"
...
mkdir tmp
cd tmp
cm "env CFLAGS=$cflag cmake ../$src -DCMAKE_INSTALL_PREFIX:PATH=$td" "cmake $pkg"
