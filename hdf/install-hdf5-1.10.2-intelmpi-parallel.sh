...
pkg=hdf5-1.10.2-intelmpi-parallel
...
echo Building $pkg...
cd $src
cm "env CC=$cc CXX=$cxx FC=$fc ./configure --enable-parallel --enable-fortran --enable-cxx --enable-unsupported --enable-optimization=high --prefix=$td" "configure $pkg"
