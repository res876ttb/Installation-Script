...
pkg=netcdf-fortran-4.4.5-intelmpi-intel
...
export CC=icc
export CXX=icpc
# export FC="ifort -I$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/include -L$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/lib -lnetcdf"
export FC=ifort
export CPPFLAGS=-I$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/include
export LDFLAGS=-L$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/lib
export LIBS="-lnetcdf"
# export FFLAGS="-I$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/include -L$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/lib -lnetcdf"
# export LDFLAGS="-L$HOME/.pkg/netcdf-4.6.2-intelmpi-intel/lib -lnetcdf"
